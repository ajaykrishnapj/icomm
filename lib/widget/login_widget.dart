                                        ...
                                        Padding(
                                          ...
                                          child:
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<IcomRecord>
                                                  emailAddressIcomRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final emailAddressIcomRecord =
                                                  emailAddressIcomRecordList
                                                          .isNotEmpty
                                                      ? emailAddressIcomRecordList
                                                          .first
                                          ...
                                          child: AuthUserStreamWidget(
                                            builder: (context) =>
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<IcomRecord>
                                                    passwordIcomRecordList =
                                                    snapshot.data!;
                                                // Return an empty Container when the item does not exist.
                                                if (snapshot.data!.isEmpty) {
                                                  return Container();
                                                }
                                                final passwordIcomRecord =
                                                    passwordIcomRecordList
                                                            .isNotEmpty
                                                        ? passwordIcomRecordList
                                                            .first
